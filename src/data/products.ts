...
export const products: Product[] = [
  ...
  },
  {
    ...
    packagingTypes: ["Pouch", "Bottle", "Bulk"],
    hasPouchPackaging: true,
    bulkPricingAvailable: true,
  },
  {
  ...
  {
    id: "premium-rice",
    name: "Radha Premium Rice",
    image: "/rice-tin.jpg",
    price: "",
    category: "Rice",
    description: "Extra long grain premium rice, pure and natural. Hygienically packed for a healthy life.",
    details: "Our Radha Premium Rice is carefully selected for its extra long grains, rich aroma, and taste. Soft, fluffy, and tasty, it's ideal for everyday meals. Available in 13kg tins.",
    packagingTypes: ["Tin"],
    hasPouchPackaging: false,
    bulkPricingAvailable: true,
  },
