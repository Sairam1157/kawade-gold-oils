  ...
  return (
    <TempleLayout watermark="kalash">
      <div className="pt-20 pb-12 relative overflow-hidden">
        {/* Divine side decorations */}
        <div className="absolute left-2 md:left-6 top-32 bottom-32 w-4 temple-pillar opacity-35 pointer-events-none" />
        <div className="absolute right-2 md:right-6 top-32 bottom-32 w-4 temple-pillar opacity-35 pointer-events-none" />
        <div className="absolute top-24 left-1/2 -translate-x-1/2 text-[120px] font-serif text-primary/[0.03] pointer-events-none select-none">&#9775;</div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="py-8 sm:py-12">
            ...
            />
            {/* Sanskrit greeting */}
            <p className="text-center text-base italic text-primary font-semibold mt-3" style={{ fontFamily: "'Noto Serif Devanagari', serif" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div className="bg-card rounded-2xl p-6 shadow-md shadow-foreground/5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${content.phoneNumber1.replace(/\s/g, "")}`} className="text-sm text-muted-foreground hover:text-primary block">{content.phoneNumber1}</a>
                      <a href={`tel:${content.phoneNumber2.replace(/\s/g, "")}`} className="text-sm text-muted-foreground hover:text-primary block">{content.phoneNumber2}</a>
                    </div>
                  </div>
                </div>
              </RevealSection>
                ...
                <div className="bg-card rounded-2xl p-6 shadow-md shadow-foreground/5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@kawadegoldoils.com" className="text-sm text-muted-foreground hover:text-primary">info@kawadegoldoils.com</a>
                    </div>
                  </div>
                </div>
              </RevealSection>
                ...
                <div className="bg-card rounded-2xl p-6 shadow-md shadow-foreground/5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.instagram.com/kawade_gold_oils?igsh=ZmU0eXBvejQyaGlp" target="_blank" rel="noreferrer" className="text-sm text-muted-foreground hover:text-primary">@kawade_gold_oils</a>
                    </div>
                  </div>
                </div>
              </RevealSection>
              ...
              <RevealSection delay={240}>
                <div className="space-y-3">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center gap-2 bg-[#25D366] w-full py-3.5 rounded-xl font-semibold text-white text-sm active:scale-[0.97]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center gap-2 bg-card border border-border w-full py-3.5 rounded-xl font-semibold text-sm hover:bg-muted"
                  >
            ...
            <RevealSection className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="bg-card rounded-2xl p-6 sm:p-8 shadow-md shadow-foreground/5 space-y-6">
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="inline-flex items-center gap-2 gold-gradient px-8 py-3.5 rounded-full font-semibold text-primary-foreground active:scale-[0.97] disabled:opacity-50 disabled:pointer-events-none"
                >
